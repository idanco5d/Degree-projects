...
public:
    ...
    ~Workplace()=default;
    int getId() const;
    vector<Citizen*> getManagers();
    string getName() const;
    int getWorkersSalary() const;
    int getManagersSalary() const;
    void hireManager(Citizen* manager);
    ...
    void hireEmployee(Condition condition, Citizen* employeeToHire,const int& managerId){
